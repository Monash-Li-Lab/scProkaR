...
and SCProkaR will extract the assay counts, metadata, and stored
reductions:
...
[`MergeBacObjects()`](https://monash-li-lab.github.io/scProka/reference/MergeBacObjects.md)
will automatically make them unique by prefixing them with the sample or
batch label when available.
