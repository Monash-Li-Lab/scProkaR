...
The same abstract graph can also be shown in its own layout, similar to a
standalone PAGA network:
...
draws fitted paths on top of the embedding. Use `max_paths` to restrict the
display to the strongest root-to-terminal trajectories when a compact summary
is preferable.
